...
The `esp_iot_framework` provides a comprehensive REST API and static files for device management and monitoring. All API endpoints are prefixed with `/_/` and support JSON format for requests and responses.
...
* List Wi-Fi profiles
    ...
    **Response body**:
    ...
    @endcode
    **Fields**:
    - `current_profile_index`: Currently active profile (0-7)
...
* Update Wi-Fi profile
    ...
    Update the values of the existing profile #X
    ...
    **Request body**:
    ...
    @endcode
    **Fields**:
    - `profile_index`: Profile number (1-7, profile #0 cannot be changed)
    - `ssid`: Network SSID (1-32 characters)
    - `password`: Network password (8-64 characters)
...
* Clear Wi-Fi profile
    ...
    Clear profile #X fields with empty values
...
* Wi-Fi network availability test
    ...
    Checking the availability of a Wi-Fi network using profile #X
    ...
    **Request Body**:
    ...
    @endcode
    **Fields**:
    - `profile_index`: Profile number (0-7)
...
* Get system information
    ...
    **Fields**:
    ...
    - `features`: Chip features (W=Wi-Fi, B=Bluetooth, L=BLE)
...
* Update administrator password
    ...
    **Request body**:
    ...
    @endcode
    **Fields**:
    - `password`: New password (8-64 characters)
