<!--
  ...
  Folder: ./examples/stepper_control_server
  File: README.md
...
An example of controlling a stepper motor via a web interface based on the [`esp_iot_framework_server`](../../components/esp_iot_framework_server/README.md).
