...
An example of controlling a relay via a web interface based on the [`esp_iot_framework_device`](../../components/esp_iot_framework_device/README.md).
